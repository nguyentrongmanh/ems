<div class="grounding-wrapper earth-breaker-element {{ $data['class'] ?? '' }}" id="{{ $data['id'] }}">
    <div class="grounding-content rotate-90">
        <div class="grounding-top">
        </div>	
        <div class="grounding-middle"></div>	
        <div class="grounding-bottom">
    ...
    <div class="electric-item-label">{{ $data['label'] }}</div>
</div>
