...
<div class="card shadow mb-4">
	...
	<div class="card-body">
		<form action="{{ route('major-add') }}" enctype="multipart/form-data" id="add-major-form" method="POST"
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<textarea style="height:200px;" class="form-control" name="introduction" ></textarea>
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">
